//package com.gentz.controller;
//
//import com.gentz.entity.Product;
//import com.gentz.service.ProductService;
...
//@CrossOrigin(origins = "http://localhost:5173") // Allow CORS for your front-end
...
//                return ResponseEntity.badRequest().body(Map.of("error", "Product image is required"));
//            }
//
//            Product savedProduct = productService.saveProductWithImage(file, name, description, category, price, stockQuantity);
//            return ResponseEntity.ok(savedProduct);
//        } catch (IOException e) {
//            e.printStackTrace();
